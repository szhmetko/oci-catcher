...
ATTEMPT_GAP="${ATTEMPT_GAP:-25}"        # пауза между попытками внутри круга
...
# --- Очередь форм -----------------------------------------------------------
# Порядок намеренный. E2.1.Micro идёт первым: он фиксированного размера и
# крошечный, планировщику OCI проще найти под него дырку, чем под непрерывный
# блок A1. Дальше A1 по возрастанию — половина квоты ловится чаще, чем полная,
# а добрать до 2 OCPU / 12 GB можно потом вторым инстансом или Edit Shape.
#
